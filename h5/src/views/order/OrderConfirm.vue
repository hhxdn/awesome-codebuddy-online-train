  ...
  <div class="order-confirm-page page-fade-in">
    ...
    <template v-if="productType === 'COURSE'">
      <div class="course-card" v-if="course.title">
        <div class="course-cover">
          <van-image :src="course.cover" width="60" height="82" fit="cover" radius="8">
            <template #error>
    ...
    <template v-else>
      <div class="course-card" v-if="category.name">
        <div class="course-cover">
          <van-image :src="category.cover" width="60" height="82" fit="cover" radius="8">
            <template #error>
